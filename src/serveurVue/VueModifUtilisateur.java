...
import serveurControleur.ControleurModifierUSer;

import java.awt.*;
import java.awt.event.ActionListener;

public class VueModifUtilisateur extends JPanel {

    private Utilisateur userInit;
	private ActionListener controleurModifierSupprimerUtilisateur;
	 ControleurModifierUSer controleurModifierUSer;
	...
	public VueModifUtilisateur(Utilisateur userInit,ControleurModifierSupprimerUtilisateur controleurModifierSupprimerUtilisateur) {

		this.controleurModifierSupprimerUtilisateur = controleurModifierSupprimerUtilisateur;
		
		this.userInit = userInit;
		
		this.controleurModifierUSer = new ControleurModifierUSer(this, controleurModifierSupprimerUtilisateur);

		
		nomT.setText(userInit.getNom());
		prenomT.setText(userInit.getPrenom());
		identT.setText(userInit.getIdentifiant());
		identT.setEditable(false);
		mdpT.setText(userInit.getPassword());
		
		valider.addActionListener(controleurModifierUSer);
		
		
		JPanel panGServ= getPanGServ();
        JPanel panDSupprimerUsers = getPanDSupprimerUsers();
        SpringLayout layout = new SpringLayout();
        setLayout(layout);
        this.add(panGServ);
        this.add(panDSupprimerUsers);
        ...
        layout.putConstraint(SpringLayout.NORTH, panDSupprimerUsers, 0, SpringLayout.NORTH, panGServ);
        layout.putConstraint(SpringLayout.WEST, panDSupprimerUsers, 0, SpringLayout.EAST, panGServ);
    ...
    public Utilisateur getUserInit() {
		return userInit;
	}
    ...
    private JPanel getPanDSupprimerUsers(){

        JPanel panDSupprimerUsers = new JPanel();
        JLabel creation = new JLabel(" - Modifier un compte utilisateur -");
        ...
        /*ici*/JButtonUtilisateur<Utilisateur> retour = new JButtonUtilisateur<Utilisateur>();
        retour.setText("<");
        retour.addActionListener(controleurModifierSupprimerUtilisateur);
        retour.setActionCommand("RET");
        
        Font font = new Font("Arial", Font.BOLD, 25);
        Font fonts = new Font("Calibri", Font.BOLD, 40);
        String[] bookTitles = new String[] {"USER","SERVICE"};
        JComboBox<String> role = new JComboBox<>(bookTitles);
        role.setSelectedItem(userInit.getTypeUtilisateur());
        role.addItemListener(controleurModifierUSer);

        //String[] groupesTitles = new String[] {"TDA1","TDA2","TDA3","TDA4","TDA5",};

        //JComboBox<String> groupesC = new JComboBox<>(groupesTitles);

        panDSupprimerUsers.setLayout(new BorderLayout());
        SpringLayout layout = new SpringLayout();
        setLayout(layout);
        panDSupprimerUsers.setLayout(layout);
        panDSupprimerUsers.setBackground(Color.GRAY);
        ...
        //panDSupprimerUsers.add(groupesC);
        panDSupprimerUsers.add(role);
        panDSupprimerUsers.add(Role);

        panDSupprimerUsers.add(creation);
        panDSupprimerUsers.add(nom);
        panDSupprimerUsers.add(prenom);
        panDSupprimerUsers.add(ident);
        panDSupprimerUsers.add(mdp);
        panDSupprimerUsers.add(nomT);
        panDSupprimerUsers.add(prenomT);
        panDSupprimerUsers.add(identT);
        panDSupprimerUsers.add(mdpT);
        panDSupprimerUsers.add(valider);
        panDSupprimerUsers.add(retour);
        ...
        panDSupprimerUsers.setSize(900,1000);
        panDSupprimerUsers.setPreferredSize(new Dimension(900,1000));


        layout.putConstraint(SpringLayout.NORTH, creation, 150, SpringLayout.NORTH, panDSupprimerUsers);
        layout.putConstraint(SpringLayout.WEST, creation, 50, SpringLayout.WEST, panDSupprimerUsers);

        layout.putConstraint(SpringLayout.NORTH, nom, 350, SpringLayout.NORTH, panDSupprimerUsers);
        layout.putConstraint(SpringLayout.WEST, nom, 35, SpringLayout.WEST, panDSupprimerUsers);
        ...
        layout.putConstraint(SpringLayout.WEST, Role, 60, SpringLayout.WEST, panDSupprimerUsers);
        ...
        layout.putConstraint(SpringLayout.NORTH, valider, 820, SpringLayout.NORTH, panDSupprimerUsers);
        layout.putConstraint(SpringLayout.WEST, valider, 380, SpringLayout.WEST, panDSupprimerUsers);

        return panDSupprimerUsers;
    }
